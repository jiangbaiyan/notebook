...
![](http://pq370w15r.bkt.clouddn.com/notebook/2019/4/23/1556021107473.png)
 - 注意此时$b所指向的zend_string的refcount变为了0？？？，而且b指向的zend_string的地址为0x7ffff5e6a5c8，与$a所指向的zend_string的地址0x7ffff5e6b0f0不同，说明发生了写时复制，即由于字符串值的改变，被迫生成了一个新的zend_string结构体，用来专门存储$b的值；而$a指向的zend_string只是refcount减少了1，其余并未发生变化。